...
class Message
{
    ...
    public function sendMessage($user_to, $body, $date)
    {
        if ($body != "") {
            $userLoggedIn = $this->user_obj->getUsername();
            $query = mysqli_query($this->con, "INSERT INTO messages VALUES (DEFAULT ,'$user_to','$userLoggedIn','$body','$date','no','no','no')");
        }
        ...
        foreach ($convos as $username) {
            ...
            $return_string .= "<a href='messages.php?u=$username'> 
                                    <div class='user_found_messages'>
                                        <img src='" . $user_found_obj->getProfilePic() . "' styles='border-radius:5px; margin-right:5px'> 
