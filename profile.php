...
<div class="profile_left">
    ...
    <div class="profile_info">
        <p>
            <?php
            echo "Posts: " . $user_array['num_posts'];
            ?>
        </p>
        <p>
            <?php
            echo "Likes: " . $user_array['num_likes'];
            ?>
        </p>
        <p>
            <?php
...
<div class="profile_main_column column">
    <ul class="nav nav-tabs" role="tablist" id="profileTabs">
        ...
        <li role="presentation"><a href="#messages_div" aria-controls="messages_div" role="tab"
    ...
    <div class="tab-content">
        ...
        <div role="tabpanel" class="tab-pane fade" id="messages_div">
            ...
            echo "<h4> You and <a href='profile.php?profile_username=" . $username . "'>" . $profile_user_obj->getFirstAndLastName() . "</a></h4> <hr>
            <br>";
